...
/*
// DEBUG: Log POST data (ON SCREEN)
echo '<pre>';
print_r($_POST);
echo '</pre>';
exit; // Stop execution here to verify data
*/
...
// Captcha check disabled to prevent chk_captcha() undefined function error
// If you need captcha, ensure captcha library is properly loaded
/*
...
// 사용자 코드 실행
// DEBUG: Log skin path
$log_path = G5_DATA_PATH . '/skin_debug.log';
$log_msg = date('Y-m-d H:i:s') . " - write_update.php\n";
$log_msg .= "board_skin_path: " . $board_skin_path . "\n";
...
// consult 게시판 커스텀 로직 제거됨 (write_update.skin.php로 이관)
