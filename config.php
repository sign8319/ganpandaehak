...
if ($_SERVER["HTTP_HOST"] != "localhost:91" && $_SERVER["HTTP_HOST"] != "localhost:98") {

    // 간판대학.com 도메인들을 HTTPS로 리다이렉트 (보안 접속 강제)
    if ($_SERVER["HTTP_HOST"] == "간판대학.com" || $_SERVER["HTTP_HOST"] == "www.간판대학.com" || $_SERVER["HTTP_HOST"] == "xn--s39am6ks52a55b.com" || $_SERVER["HTTP_HOST"] == "www.xn--s39am6ks52a55b.com") {
...
if (G5_DOMAIN) {
    ...
    if (isset($g5_path['url']))
        ...
        define('G5_URL', '/ganpandaehak');  // 여기를 수정!
}
