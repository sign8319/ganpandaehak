...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
	...
	makePopupURL: function () {
		...
		var sPopupUrl = "./photo_uploader/popup/index.html?ver=NEW_feature_v2";
		return sPopupUrl;
	},
	...
	_getPhotoTag: function (htPhotoInfo) {
		...
		var sTag = '<img src="{=sOriginalImageURL}" title="{=sName}" alt="{=sName}" style="max-width:50%; height:auto;">';
