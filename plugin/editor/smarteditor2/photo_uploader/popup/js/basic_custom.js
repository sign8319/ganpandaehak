...
jQuery(function ($) {
    ...
    var gnu = {
        ...
        _add: function (e, data, preload) {
            ...
            $.each(data.files, function (index, file) {
                ...
                var node = $('<div/>')
                    .append($('<input type="text" class="rename_input" style="width:100px; border:1px solid #ddd; padding:2px;" />').val(file.name.replace(/\.[^/.]+$/, "")))
    ...
    $("#img_upload_submit").bind("click", function (e) {
        ...
        $(gnu.dreg_area_list).find(".delete_img").each(function (i, f) {
            ...
            aResult[j]['sAlign'] = '';
            aResult[j]['sFileName'] = $(this).parent().find("input.rename_input").val();
