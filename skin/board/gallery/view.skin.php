    ...
    <section id="bo_v_info">
        ...
        <div id="bo_v_top">
            ...
            <ul class="btn_bo_user bo_v_com">
                ...
                <li>
                    <a href="<?php echo G5_BBS_URL; ?>/write.php?bo_table=consult&subject=<?php echo urlencode('[견적문의] ' . $view['wr_subject']); ?>&link=<?php echo urlencode(get_pretty_url($bo_table, $view['wr_id'])); ?>"
                        class="btn_b01 btn" style="background:#ea580c; color:#fff; border-color:#ea580c;"
                        title="이 컨셉으로 견적 받기">
                        <i class="fa fa-paper-plane" aria-hidden="true"></i> 이 컨셉으로 견적 받기
                    </a>
                </li>
                <?php if ($reply_href) { ?>
