<?php
// [Refactor] bo_table은 URL 파라미터로 전달됨 (?bo_table=consult)
...
if (!isset($_REQUEST['bo_table']) || !$_REQUEST['bo_table']) {
    $_GET['bo_table'] = 'consult';
    $_REQUEST['bo_table'] = 'consult';
    $bo_table = 'consult';
}
            ...
            <div
                ...
                <div class="mb-6 border-b pb-4 border-gray-100 flex justify-between items-center flex-none">
                    <h2 class="text-2xl font-bold text-gray-800">
                        견적신청 관리
                        <span class="text-sm font-normal text-gray-500 ml-2">고객 문의 및 견적 요청 내역</span>
                    </h2>
