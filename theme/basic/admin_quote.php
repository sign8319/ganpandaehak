    ...
    <div class="max-w-[1600px] mx-auto">
        ...
        <div
            ...
            <div class="flex gap-2 w-full lg:w-auto">
                <button onclick="location.href='./admin_assets.php'"
                    ...
                    <span class="text-base">🖼️</span> <span class="lg:hidden">이미지 자산</span><span
                        class="hidden lg:inline">이미지 자산관리</span>
                </button>
                    ...
                    <div class="flex gap-2 px-2 self-end lg:self-auto">
                        <?php if ($q): ?>
                            <button type="button" onclick="location.href='./admin_quote.php'"
                                class="bg-white border border-gray-300 text-gray-700 px-4 py-2.5 lg:py-2 rounded-lg text-sm font-bold hover:bg-gray-50 hover:text-orange-600 transition flex items-center gap-2 shadow-sm">
                                <span class="text-xs">✕</span> 전체보기
                            </button>
                        <?php else: ?>
                            <button type="button" onclick="location.href='./admin_quote.php'"
                        ...
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-12 lg:col-span-4">
                                ...
                                <input type="email" name="qa_client_email" value="<?php echo $quote['qa_client_email']; ?>"
                                    class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 text-xs py-2"
                            ...
                            <table class="w-full text-left border-collapse min-w-[800px]" id="tbl_items_new">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th class="py-3 px-1 md:px-2 w-16 md:w-24 text-center">가로<br class="md:hidden" />(W)
                                        </th>
                                        <th class="py-3 px-1 md:px-2 w-16 md:w-24 text-center">세로<br class="md:hidden" />(H)
                                        </th>
