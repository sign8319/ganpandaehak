...
<div id="optionModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-xl max-w-md w-full">
        ...
        <form id="optionForm" class="p-6 space-y-4">
            ...
            <div id="priceField">
                <label class="block text-sm font-medium text-gray-700 mb-2">추가 금액 (원)</label>
...
<script>
            ...
            .then(data => {
                ...
                data.forEach(option => {
                    ...
                    const valueText = isDiscount
                        ...
                        : `+${parseInt(option.price).toLocaleString()}원`;
                    const typeText = isDiscount ? '할인' : '추가금액';
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <span class="px-2 py-1 text-xs rounded-full ${isDiscount ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'}">
                                ${typeText}
                            </span>
                        </td>
    ...
    document.getElementById('optionForm').addEventListener('submit', function (e) {
        ...
        if (type === 'discount') {
            ...
            formData.append('price', document.getElementById('option_price').value);
