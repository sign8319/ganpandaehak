...
$tables = [
  ...
  "CREATE TABLE IF NOT EXISTS `g5_quote_products` (
      ...
      `price_xlarge` decimal(10,2) DEFAULT NULL,
      `width_surcharge_1800` decimal(10,2) DEFAULT 0,
      `use_width_pricing` tinyint(1) DEFAULT 0,
  ...
  "CREATE TABLE IF NOT EXISTS `g5_quote_options` (
      ...
      `unit_type` enum('fixed','per_m2','quantity') DEFAULT 'fixed',
      `free_qty` int(11) DEFAULT 0,
      `qty_unit_price` decimal(10,2) DEFAULT 0,
