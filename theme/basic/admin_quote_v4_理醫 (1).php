                            ...
                            <div class="grid grid-cols-12 gap-4">
                                ...
                                <div class="col-span-12 lg:col-span-4">
                                    ...
                                    <div class="relative">
                                        <select id="qa_status_select" onchange="handle_status_change(this)"
                                            class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 text-sm font-bold">
                                            <?php
                                            ...
                                            ?>
                                            <option value="__custom__" <?php echo $is_custom ? 'selected' : ''; ?>>➕ 직접 입력...</option>
                                        </select>
                                        <input type="text" name="qa_status" id="qa_status_input" 
                                            value="<?php echo $current_status; ?>"
                                            placeholder="상태를 입력하세요"
                                            class="<?php echo $is_custom ? '' : 'hidden'; ?> absolute inset-0 w-full p-2.5 border-2 border-orange-500 rounded-lg focus:ring-2 focus:ring-orange-500 text-sm font-bold bg-white">
                                    </div>
                                ...
                                <div class="col-span-12 lg:col-span-4">
                                    ...
                                    <input type="email" name="qa_client_email"
                                        value="<?php echo $quote['qa_client_email']; ?>"
                                        class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 text-sm"
...
<dialog id="biz_config_modal" class="p-0 rounded-xl shadow-2xl backdrop:bg-black/50" style="max-width: 700px; width: 90vw;">
        ...
        <form action="./admin_quote.php" method="post" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div class="border-b pb-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div><label class="block text-xs font-bold mb-1 text-gray-600">상호(법인명)</label><input type="text" name="biz_name"
                            value="<?php echo $biz_info['biz_name'] ?? ''; ?>" class="w-full border border-gray-300 p-2.5 rounded focus:border-orange-500 focus:ring-1 focus:ring-orange-500"></div>
                    <div><label class="block text-xs font-bold mb-1 text-gray-600">사업자등록번호</label><input type="text" name="biz_no"
                            value="<?php echo $biz_info['biz_no'] ?? ''; ?>" class="w-full border border-gray-300 p-2.5 rounded focus:border-orange-500 focus:ring-1 focus:ring-orange-500"></div>
                    <div><label class="block text-xs font-bold mb-1 text-gray-600">대표자성명</label><input type="text" name="biz_ceo"
                            value="<?php echo $biz_info['biz_ceo'] ?? ''; ?>" class="w-full border border-gray-300 p-2.5 rounded focus:border-orange-500 focus:ring-1 focus:ring-orange-500"></div>
                    <div><label class="block text-xs font-bold mb-1 text-gray-600">대표전화</label><input type="text" name="biz_tel"
                            value="<?php echo $biz_info['biz_tel'] ?? ''; ?>" class="w-full border border-gray-300 p-2.5 rounded focus:border-orange-500 focus:ring-1 focus:ring-orange-500"></div>
                    <div class="col-span-2"><label class="block text-xs font-bold mb-1 text-gray-600">사업장 주소</label><input type="text"
                            name="biz_addr" value="<?php echo $biz_info['biz_addr'] ?? ''; ?>"
                            class="w-full border border-gray-300 p-2.5 rounded focus:border-orange-500 focus:ring-1 focus:ring-orange-500"></div>
                    <div><label class="block text-xs font-bold mb-1 text-gray-600">업태</label><input type="text" name="biz_type"
                            value="<?php echo $biz_info['biz_type'] ?? ''; ?>" class="w-full border border-gray-300 p-2.5 rounded focus:border-orange-500 focus:ring-1 focus:ring-orange-500"></div>
                    <div><label class="block text-xs font-bold mb-1 text-gray-600">종목</label><input type="text" name="biz_class"
                            value="<?php echo $biz_info['biz_class'] ?? ''; ?>" class="w-full border border-gray-300 p-2.5 rounded focus:border-orange-500 focus:ring-1 focus:ring-orange-500"></div>
                    <div class="col-span-2"><label class="block text-xs font-bold mb-1 text-gray-600">이메일</label><input type="email"
                        ...
                        <div class="mt-3 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <label class="inline-flex items-center mt-1">
                                    <input type="checkbox" name="delete_seal" value="1" class="rounded border-gray-300 text-red-600 focus:ring-red-500">
            ...
            <div class="pt-4 text-right flex gap-2 justify-end">
                ...
                <button type="submit"
                    class="bg-orange-600 text-white px-6 py-2.5 rounded-lg font-bold hover:bg-orange-700 transition">💾 저장하기</button>
            </div>
        </form>
    </div>
</dialog>
...
<script>
    ...
    window.preview_action_email = function() {
        ...
        if (confirm('이메일을 발송하시겠습니까?')) {
            location.href = './admin_quote.php?w=mail&qa_id=' + currentPreviewId + '&token=<?php echo $token; ?>';
        }
    }
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
            <div class="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-4 flex justify-between items-center">
                ...
                <button onclick="close_summary_modal()" class="text-white hover:text-gray-200 text-2xl leading-none">&times;</button>
            </div>
            ...
            <div class="bg-gray-50 px-6 py-3 flex justify-end gap-2">
                ...
                <button type="button" onclick="open_full_quote()"
                    class="bg-orange-600 text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-orange-700">전체 보기</button>
            </div>
        </div>
    </div>
</div>
