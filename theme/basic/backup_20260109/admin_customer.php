...
if ($w == 'register_complete' && $qa_id) {
    ...
    $qa_construct_date_sql = (empty($qa_construct_date)) ? "NULL" : "'" . addslashes($qa_construct_date) . "'";

    $qa_deposit_status = addslashes($_POST['qa_deposit_status'] ?? '입금대기');
    $qa_payment_method = addslashes($_POST['qa_payment_method'] ?? '현금');
    $qa_tax_yn = addslashes($_POST['qa_tax_yn'] ?? 'N');
    $qa_tax_biz_num = addslashes($_POST['qa_tax_biz_num'] ?? '');
    $qa_tax_company_name = addslashes($_POST['qa_tax_company_name'] ?? '');
    $qa_tax_ceo_name = addslashes($_POST['qa_tax_ceo_name'] ?? '');
    $qa_tax_addr = addslashes($_POST['qa_tax_addr'] ?? '');
    $qa_tax_email = addslashes($_POST['qa_tax_email'] ?? '');
    $qa_tax_type = addslashes($_POST['qa_tax_type'] ?? '');
    $qa_tax_claim_type = addslashes($_POST['qa_tax_claim_type'] ?? '');
    $qa_tax_item_name = addslashes($_POST['qa_tax_item_name'] ?? '');
                            ...
                            <div class="space-y-3 text-sm">
                                ...
                                <div class="border-t border-gray-200 pt-2 mt-2">
                                    ...
                                    <span class="font-bold text-gray-700">
                                        <?php echo $quote_data['qa_tax_trade_name'] ?? '-'; ?>
                                    </span>
                                </div>
                            </div>
                        </div>
