...
<div id="quote_wrap">
    ...
    <div class="quote-header">
        <div class="header-top">
            <div class="logo-area">
                <img src="<?php echo G5_DATA_URL; ?>/assets/asset_20251228193653_7935.png" alt="간판대학 로고">
    ...
    <div class="quote-content">
        ...
        <div class="info-grid">
                ...
                <div class="info-details">
                    ...
                    <?php if ($quote['qa_client_addr'] || $quote['qa_client_addr2']): ?>
                        <div class="info-line">
                            ...
                            <span
                                class="val"><?php echo trim($quote['qa_client_addr'] . ' ' . $quote['qa_client_addr2']); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="info-box supplier">
                ...
                <div class="info-name"><?php echo !empty($biz_info['biz_name']) ? $biz_info['biz_name'] : '간판대학'; ?>
                </div>
                <div class="info-details">
    ...
    <div class="quote-footer">
        ...
        <div class="footer-address">
            <?php echo !empty($biz_info['biz_addr']) ? $biz_info['biz_addr'] : '서울특별시 성북구 정릉로 23길 29-2, 1층'; ?></div>
