...
<!-- 게시판 목록 시작 { -->
<div id="bo_list" style="width:<?php echo $width; ?>" class="container py-4">
            ...
            <table>
                ...
                <tbody>
                    ...
                    for ($i = 0; $i < count($list); $i++) {
                        // [FILTER] Show only Quick Consult requests (hide standard quotes)
                        if (strpos($list[$i]['subject'], '퀵상담 신청') === false)
                            continue;
