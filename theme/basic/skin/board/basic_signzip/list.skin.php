...
<!-- 게시판 목록 시작 { -->
<div id="bo_list" style="width:<?php echo $width; ?>" class="container">
    <div
        ...
        <h1 class="text-center text-white text-5xl font-bold leading-[48px] break-keep">
            <?php echo $board['bo_subject'] ?></h1>
    </div>
    ...
    <form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php"
        ...
        <div class="flex justify-center items-start px-4 sm:px-8 md:px-12 lg:px-20">
            <div class="w-full max-w-6xl py-8 flex flex-col items-start">
                ...
                <div class="w-full flex flex-col overflow-x-auto">
                    <div class="min-w-[250px] sm:min-w-[320px] md:min-w-[400px] lg:min-w-[500px] w-full flex flex-col">
                        <div class="flex bg-stone-50 border-t border-b border-zinc-100">
                            <div class="w-8 sm:w-12 md:w-16 px-1 sm:px-2 py-3 sm:py-4 flex items-center justify-center">
                                <div
                            ...
                            <div class="hidden sm:flex w-20 sm:w-24 px-1 sm:px-3 py-3 sm:py-4 items-center">
                                <div
                                    class="text-neutral-600 text-xs sm:text-sm md:text-base font-semibold leading-normal">
                                    카테고리</div>
                            </div>
                            <div
                                class="hidden sm:hidden md:block lg:block sm:flex w-24 sm:w-32 px-1 sm:px-3 py-3 sm:py-4 items-center justify-end">
                                <div
                                    class="text-neutral-600 text-xs sm:text-sm md:text-base font-semibold leading-normal">
                                    등록일</div>
                            </div>
                                    ...
                                    <div class="flex border-b border-zinc-100 hover:bg-gray-50 transition">
                                        ...
                                        <div class="hidden sm:flex w-20 sm:w-24 px-1 sm:px-3 py-3 sm:py-4 items-center">
                                            <div
                                                ...
                                                <?php echo $row['ca_name'] ? $row['ca_name'] : '-'; ?>
                                            </div>
                                        </div>
                                        <div
                                            class="hidden sm:hidden md:block lg:block sm:flex w-24 sm:w-32 px-1 sm:px-3 py-3 sm:py-4 items-center justify-end">
                ...
                <div class="pt-8 w-full flex justify-end">
                    <?php if ($write_href) { ?>
                        <a href="<?php echo $write_href; ?>"
                            class="inline-flex items-center px-6 py-2 bg-accent rounded-lg hover:bg-lime-500 transition text-black text-base font-normal">
