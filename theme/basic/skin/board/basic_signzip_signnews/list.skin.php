                ...
                <div class="w-full flex flex-col overflow-x-auto">
                    <div class="min-w-[250px] sm:min-w-[320px] md:min-w-[400px] lg:min-w-[500px] w-full flex flex-col">
                        <div class="flex bg-stone-50 border-t border-b border-zinc-100">
                            <?php if ($is_checkbox) { ?>
                                <div class="w-8 sm:w-10 md:w-12 px-1 sm:px-2 py-3 sm:py-4 flex items-center justify-center">
                            ...
                            <div
                                class="hidden sm:hidden md:block lg:block w-20 sm:w-24 px-1 sm:px-3 py-3 sm:py-4 flex items-center">
                                <div
                                    class="text-neutral-600 text-xs sm:text-sm md:text-base font-semibold leading-normal">
                                    카테고리</div>
                            </div>
                            <div
                                class="hidden sm:hidden md:block lg:block w-24 sm:w-32 px-1 sm:px-3 py-3 sm:py-4 flex items-center justify-end">
                                <div
                                    class="text-neutral-600 text-xs sm:text-sm md:text-base font-semibold leading-normal">
                                    등록일</div>
                            </div>
