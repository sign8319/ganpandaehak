...
<article id="bo_v" style="width:<?php echo $width; ?>; background: transparent;" class="container py-4">
    <header>
        <h2 id="bo_v_title">
            ...
            ?></span>
            <span class="text-gray-500 text-sm leading-tight w-full truncate">
            <?php
            echo cut_str(get_text($view['wr_1']), 70); // 글 부제목 출력
            ?></span>
        </h2>
    </header>
    ...
    <section id="bo_v_link">
        ...
        for ($i=1; $i<=count($view['link']); $i++) {
            ...
            <li>
                ...
                <br>
                <span class="bo_v_link_cnt"><?php echo isset($view['link_hit'][$i]) ? $view['link_hit'][$i] : 0; ?>회 연결</span>
            </li>
            <?php
            }
        }
