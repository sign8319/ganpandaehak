...
<section id="bo_w" class="container">
    ...
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);"
        ...
        <div class="bo_w_location write_div">
            <label for="wr_1" class="sound_only">위치 (예: 서울 성북구)</label>
            <input type="text" name="wr_1" value="<?php echo $wr_1 ?? ''; ?>" id="wr_1" required
                class="frm_input full_input required" size="50" maxlength="100" placeholder="위치 (예: 서울 성북구)">
        </div>

        <div class="bo_w_summary write_div">
            <label for="wr_2" class="sound_only">예상 견적 (예: 100만원대)</label>
            <input type="text" name="wr_2" value="<?php echo $wr_2 ?? ''; ?>" id="wr_2" required
                class="frm_input full_input required" size="50" maxlength="100" placeholder="예상 견적 (예: 100만원대)">
        </div>
