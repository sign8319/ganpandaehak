...
<article id="bo_v" style="width:<?php echo $width; ?>; background: transparent;" class="container py-4">
    ...
    <div class="portfolio-view__body w-full max-w-[1248px] bg-white rounded-2xl p-8 flex flex-col gap-8">
        <!-- 본문 설명 -->
        <div class="text-gray-700 text-base font-normal leading-relaxed">
        ...
        <div class="flex flex-wrap gap-6">
            ...
            <div class="rounded-2xl overflow-hidden">
                <img class="w-[580px] h-64 max-w-[580px] object-cover" src="<?php echo G5_DATA_URL.'/file/'.$bo_table.'/'.$img['file']; ?>" alt="<?php echo htmlspecialchars($img['source']); ?>" />
            </div>
            <?php } ?>
        </div>
        <?php } ?>
        ...
        <div class="pt-4">
            <div class="text-black text-xl font-bold leading-7 mb-4">주요 특징</div>
            <ul class="space-y-2">
                <?php foreach($view['features'] as $feature) { ?>
                <li class="text-gray-700 text-base font-normal leading-normal flex items-center">
