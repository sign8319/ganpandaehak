...
<article id="bo_v" style="width:<?php echo $width; ?>; background: transparent;" class="container pt-36 pb-20">
    <!-- 돌아가기 버튼 -->
    <div class="portfolio-view__back pb-8 flex items-center">
        <a href="<?php echo $list_href; ?>"
            class="flex items-center text-gray-600 text-base font-normal leading-normal hover:underline">
            <img src="<?php echo G5_IMG_URL; ?>/back_arrow.png" alt="뒤로가기" class="w-4 h-4 mr-2"
    ...
    <div class="portfolio-view__header">
        <div class="w-full max-w-[1248px] bg-white rounded-2xl p-6 flex flex-col gap-2">
            <div class="flex-col md:flex-row justify-between items-start">
                <div class="flex-1">
                    <div class="text-gray-500 text-lg font-normal leading-7">
                        <?php echo $view['wr_1'] ?? ($view['wr_1'] ?? ''); ?>
                    </div>
                    <div class="text-black text-3xl font-bold leading-9">
                        <?php echo get_text($view['wr_subject']); ?>
                    </div>
                    <div class="text-gray-500 text-lg font-normal leading-7 mt-2">
                    ...
                    <div class="flex justify-end gap-2 ml-4">
                        <?php if ($update_href) { ?>
                            <a href="<?php echo $update_href; ?>"
                                class="inline-flex items-center px-4 py-2 bg-white text-black border border-gray-200 text-sm  font-medium rounded-lg">
                                <img src="<?php echo G5_IMG_URL; ?>/edit_icon.png" alt="수정" class="w-4 h-4 mr-2"
                                    onerror="this.style.display='none';">
                                수정
                            </a>
                        <?php } ?>
                        <?php if ($delete_href) { ?>
                            <a href="<?php echo $delete_href; ?>"
                                ...
                                <img src="<?php echo G5_IMG_URL; ?>/delete_icon.png" alt="삭제" class="w-4 h-4 mr-2"
                                    onerror="this.style.display='none';">
                                삭제
                            </a>
                        <?php } ?>
