    ...
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);"
        ...
        <div class="bo_w_info write_div">
            ...
            <div class="form-group mb-4">
                <label class="block text-sm font-bold text-gray-700 mb-2">별점 <strong
                        class="text-orange-500">*</strong></label>
                <div class="star-rating-input flex flex-row-reverse justify-end gap-1">
                    <?php for ($i = 5; $i >= 1; $i--) { ?>
                        <input type="radio" id="star<?php echo $i ?>" name="wr_1" value="<?php echo $i ?>"
                            class="hidden peer" <?php echo ($write['wr_1'] == $i) ? 'checked' : ''; ?> required>
                        <label for="star<?php echo $i ?>"
                            class="cursor-pointer text-gray-300 peer-checked:text-orange-500 peer-hover:text-orange-400 hover:text-orange-400 text-3xl transition-colors">★</label>
                    <?php } ?>
                </div>
                <p class="text-xs text-gray-500 mt-1">만족하신 만큼 별점을 눌러주세요.</p>
            </div>

            <!-- [NEW] 지역 선택 (wr_2) -->
            <div class="form-group mb-4">
                <label for="wr_2" class="block text-sm font-bold text-gray-700 mb-2">시공 지역 <strong
                        class="text-orange-500">*</strong></label>
                <select name="wr_2" id="wr_2"
                    class="frm_input full_input w-full border border-gray-300 rounded px-3 py-2 focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors"
                    required>
