        ...
        <div class="w-full max-w-[1248px] bg-white rounded-2xl p-6 flex flex-col gap-2">
            <div class="flex-col md:flex-row justify-between items-start">
                <div class="flex-1 pb-4"> 
                    ...
                    <?php if ($view['ca_name']) { ?>
                    <div class="mb-3">
                        <span class="inline-flex items-center px-3 py-1 bg-accent text-black text-sm font-medium rounded-full">
                            <?php echo $view['ca_name']; ?>
                        </span>
                    </div>
                    <?php } ?>
                    
                    <div class="text-black text-3xl font-bold leading-9 mb-2">
                        <?php echo get_text($view['wr_subject']); ?>
                    </div>
                    
                    <!-- 요약 내용 -->
                    <?php if ($view['wr_1']) { ?>
                    <div class="text-gray-600 text-base font-normal leading-relaxed ">
