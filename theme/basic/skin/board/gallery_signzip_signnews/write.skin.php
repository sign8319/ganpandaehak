...
<section id="bo_w" class="container">
    ...
    <div class="write_div">
        <label for="wr_1" class="sound_only">요약 내용<strong>필수</strong></label>
        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input full_input" size="50" maxlength="255" placeholder="요약 내용">
    </div>
