                            ...
                            <div class="card-image-container relative aspect-square shrink-0">
                                <?php if ($is_ba) { ?>
                                    ...
                                    <div class="ba-slider-container">
                                        ...
                                        <!-- Labels -->
                                        <span class="ba-label ba-label-before" data-label-before="<?php echo $i; ?>">Before</span>
                                        <span class="ba-label ba-label-after" data-label-after="<?php echo $i; ?>">After</span>
                                    </div>
                                <?php } else { ?>
                                    <!-- 일반 이미지 -->
                            ...
                            <div class="p-6 flex flex-col flex-1">
                                <?php if ($is_ba) { ?>
                                    ...
                                    <div class="flex items-center justify-between mb-2">
                                        <span class="px-2 py-0.5 bg-orange-100 text-orange-600 text-[10px] font-bold rounded">
                                            <?php echo htmlspecialchars($category); ?>
                                        </span>
    ...
    const baCards = document.querySelectorAll('.ba-slider-container');
        ...
        baCards.forEach((card) => {
            ...
            function updateSlider(x, rectWidth) {
                ...
                // Right Label (After): Hide if width > 85%
                if (percentage > 85) {
