        ...
        <div class="thumbnail-selector">
            ...
            <div id="fixed-content" class="tab-content active">
                <div class="upload-box" id="fixed-upload-box"
                    ...
                    <input type="file" id="fixed-file-input" name="bf_file[]" accept="image/*" style="display:none"
                ...
                <div class="ba-grid">
                    ...
                    <div class="ba-upload-section">
                        ...
                        <div class="upload-box small" id="before-upload-box"
                            ...
                            <input type="file" id="before-file-input" name="bf_file[]" accept="image/*"
                    ...
                    <div class="ba-upload-section">
                        ...
                        <div class="upload-box small" id="after-upload-box"
                            ...
                            <input type="file" id="after-file-input" name="bf_file[]" accept="image/*"
                ...
                <div class="detail-display-options">
                    ...
                    <div class="radio-group">
                        <label class="radio-label">
                            <input type="radio" name="wr_11" value="before">
                            <span>Before만 표시</span>
                        </label>
                        <label class="radio-label checked">
                            <input type="radio" name="wr_11" value="after" checked>
                            <span>After만 표시 (추천)</span>
                        </label>
                        <label class="radio-label">
                            <input type="radio" name="wr_11" value="auto">
