...
<div class="max-w-4xl mx-auto px-4 py-12">
    ...
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);"
        ...
        <!-- 가격 (wr_1) -->
        <div>
            <label for="wr_1" class="block text-sm font-medium text-gray-700 mb-1">가격</label>
            <div class="relative">
                <input type="text" name="wr_1" value="<?php echo isset($write['wr_1']) ? $write['wr_1'] : ''; ?>"
                    id="wr_1"
                    class="w-full border-gray-300 rounded-lg shadow-sm focus:border-brand-orange focus:ring focus:ring-brand-orange focus:ring-opacity-50 p-3 pl-3 pr-10"
                    placeholder="예: 350,000">
                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    <span class="text-gray-500">원</span>
                </div>
            </div>
            <p class="text-xs text-gray-500 mt-1">* 숫자만 입력하거나 '상담문의' 등으로 입력하세요.</p>
        </div>
