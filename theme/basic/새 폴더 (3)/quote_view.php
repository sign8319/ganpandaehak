...
<div id="quote_wrap">
    ...
    <!-- Fixed Message (if set) -->
    <?php if (!empty($biz_info['quote_fixed_message'])): ?>
        <div class="mb-8 bg-blue-50 border-l-4 border-blue-500 p-5 rounded-r-lg">
            ...
            <div class="text-gray-700 text-sm leading-relaxed whitespace-pre-line">
                <?php echo nl2br(htmlspecialchars($biz_info['quote_fixed_message'])); ?>
            </div>
        </div>
    <?php endif; ?>
    ...
    <!-- Footer -->
    <div class="mt-auto border-t-2 border-gray-800 pt-6 relative">
        ...
        <?php if (!empty($biz_info['company_seal'])): ?>
            <div class="absolute bottom-4 right-0">
                <img src="<?php echo G5_DATA_URL . '/quote/' . $biz_info['company_seal']; ?>" 
                     alt="직인" class="h-20 w-20 object-contain opacity-90">
            </div>
        <?php endif; ?>
    </div>
