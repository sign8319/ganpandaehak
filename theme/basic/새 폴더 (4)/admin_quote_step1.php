                        ...
                        <div class="measure-row border border-gray-200 rounded-lg p-4 mb-3 bg-gray-50"
                            ...
                            <div class="flex flex-col md:flex-row items-start gap-3">
                                <div class="flex-1 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 w-full">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <div class="relative">
                                            <?php
                                            $current_type = $m['qm_type'];
                                            $is_custom_type = !empty($current_type) && !in_array($current_type, $sign_types);
                                            ?>
                                            <select name="qm_type_select[]" onchange="handleSignTypeChange(this)"
                                                class="sign-type-select w-full px-3 py-2.5 md:py-2 border border-gray-300 rounded text-sm md:text-base <?php echo $is_custom_type ? 'hidden' : ''; ?>">
                                                <option value="">선택</option>
                                                <?php foreach ($sign_types as $type): ?>
                                                    <option value="<?php echo $type; ?>" <?php echo $current_type == $type ? 'selected' : ''; ?>><?php echo $type; ?></option>
                                                <?php endforeach; ?>
                                                <option value="__custom__" <?php echo $is_custom_type ? 'selected' : ''; ?>>직접입력</option>
                                            </select>
                                            <input type="text" name="qm_type[]" value="<?php echo $current_type; ?>"
                                                class="sign-type-input <?php echo $is_custom_type ? '' : 'hidden'; ?> absolute inset-0 w-full px-3 py-2.5 md:py-2 border border-orange-500 rounded text-sm md:text-base"
                                                placeholder="직접 입력">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <input type="text" name="qm_width[]" value="<?php echo $m['qm_width']; ?>"
                                            placeholder="450" class="w-full px-3 py-2.5 md:py-2 border border-gray-300 rounded text-sm md:text-base">
                                    </div>
                                    ...
                                    <div class="col-span-2 sm:col-span-1">
                                        ...
                                        <input type="text" name="qm_memo[]" value="<?php echo $m['qm_memo']; ?>"
                                            placeholder="메모" class="w-full px-3 py-2.5 md:py-2 border border-gray-300 rounded text-sm md:text-base">
                                    </div>
                                </div>
                            ...
                            <div class="mt-3 grid grid-cols-2 gap-3">
                                <?php for ($img_idx = 1; $img_idx <= 2; $img_idx++): ?>
                                    <div>
                                        <label class="block text-xs font-semibold text-gray-600 mb-2">사진 <?php echo $img_idx; ?></label>
...
<script>
    ...
    function addMeasureRow() {
        ...
        if (currentSignTypes.length > 0) {
            currentSignTypes.forEach(type => {
                optionsHtml += `<option value="${type}">${type}</option>`;
            });
        }
        optionsHtml += '<option value="__custom__">직접입력</option>';
            ...
            <div class="flex flex-col md:flex-row items-start gap-3">
                <div class="flex-1 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 w-full">
                    <div class="col-span-2">
                        ...
                        <div class="relative">
                            <select name="qm_type_select[]" onchange="handleSignTypeChange(this)"
                                class="sign-type-select w-full px-3 py-2.5 md:py-2 border border-gray-300 rounded text-sm md:text-base">
                                ${optionsHtml}
                            </select>
                            <input type="text" name="qm_type[]" 
                                class="sign-type-input hidden absolute inset-0 w-full px-3 py-2.5 md:py-2 border border-orange-500 rounded text-sm md:text-base"
                                placeholder="직접 입력">
                        </div>
                    </div>
                    <div class="col-span-1">
