                ...
                <tr class="hover:bg-orange-50 transition cursor-pointer"
                    ...
                    <td class="p-4 text-center">
                        <a href="?w=form&qa_id=<?php echo $row['qa_id']; ?>"
                            class="text-blue-600 hover:text-blue-800 font-bold text-sm bg-blue-50 px-3 py-1.5 rounded inline-block">수정</a>
                    </td>
                    <td class="p-4 text-center">
                        <button type="button" onclick="open_preview_modal(<?php echo $row['qa_id']; ?>); event.stopPropagation();"
                            class="bg-white border hover:bg-gray-50 text-gray-700 px-3 py-1.5 rounded text-sm shadow-sm inline-flex items-center gap-1 transition">
                            <span>👁️</span> 보기
                        </button>
                    </td>
                </tr>
...
if ($w == 'u' || $w == 'c') {
    ...
    $qa_status = $_POST['qa_status'] ?? '작성중'; // Status
...
<div class="w-full px-6 py-8 min-h-screen bg-gray-50/50">
    <div class="max-w-[1600px] mx-auto">
        ...
        <div
            ...
            <div>
                ...
                if ($w == 'form') {
                    $page_title = '견적 작성';
                    $page_subtitle = 'Estimate Creation';
                } else {
                    $page_title = '고객 관리 시스템';
                    $page_subtitle = 'Customer Management System';
                }
                ?>
                <h1 class="text-xl lg:text-2xl font-extrabold text-gray-900 tracking-tight">
                    <?php echo $page_title; ?>
                    <span
                        class="text-orange-600 text-sm font-medium ml-2 hidden md:inline"><?php echo $page_subtitle; ?></span>
                </h1>
            ...
            <div class="flex gap-2 w-full lg:w-auto">
                <button onclick="document.getElementById('biz_config_modal').showModal()"
                    class="flex-1 lg:flex-none bg-white border text-gray-700 px-3 py-2 lg:px-4 rounded-lg text-sm font-bold shadow-sm hover:bg-gray-50 transition flex justify-center items-center gap-1">
                    <span class="text-base">⚙️</span> <span class="lg:hidden">설정</span><span
                        class="hidden lg:inline">설정</span>
                </button>

                <!-- New Dropdown Button -->
                <div class="relative flex-1 lg:flex-none" x-data="{ open: false }">
                    <button @click="open = !open"
                        class="w-full lg:w-auto bg-gray-900 hover:bg-black text-white px-4 py-2 rounded-lg text-sm font-bold shadow transition flex justify-center items-center gap-2">
                        <span class="text-lg leading-none">+</span> 고객 등록
                    </button>
                    <!-- Dropdown Menu -->
                    <div x-show="open" @click.outside="open = false"
                        ...
                        class="absolute right-0 mt-2 w-full lg:w-48 bg-white rounded-xl shadow-2xl border border-gray-100 z-50 overflow-hidden"
                        style="display: none;">
                        <div class="py-1">
                            <a href="./admin_quote_step1.php"
                                class="block px-4 py-3 text-sm text-gray-700 hover:bg-orange-50 hover:text-orange-600 font-bold border-b border-gray-50 flex items-center gap-3 transition-colors">
                                <span class="text-lg">📏</span> 현장실측
                            </a>
                            <a href="./admin_quote.php?w=form"
                                class="block px-4 py-3 text-sm text-gray-700 hover:bg-orange-50 hover:text-orange-600 font-bold border-b border-gray-50 flex items-center gap-3 transition-colors">
                                <span class="text-lg">📝</span> 견적작성
                            </a>
                            <a href="./admin_customer.php"
                                class="block px-4 py-3 text-sm text-gray-700 hover:bg-orange-50 hover:text-orange-600 font-bold flex items-center gap-3 transition-colors">
                                <span class="text-lg">👤</span> 고객등록
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <?php if ($w == ''): // -------------------- LIST VIEW -------------------- ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
                    ...
                    <form name="fsearch" id="fsearch" method="get"
                        ...
                        <div class="flex flex-col lg:flex-row gap-2 items-stretch lg:items-center w-full lg:w-auto">
                            ...
                            <button type="submit"
                                class="bg-gray-800 text-white px-4 py-2.5 lg:py-2 rounded-lg text-sm font-medium hover:bg-gray-700 w-full lg:w-auto">검색</button>
                        </div>

                        <div class="flex gap-2 px-2 self-end lg:self-auto">
                            <button type="button" onclick="location.href='./admin_quote.php'"
                                class="text-xs text-gray-400 underline hover:text-red-500">필터 초기화</button>
                        </div>
                    </form>

                    <!-- Month Tabs with Year Select -->
                    <div class="px-4 pt-4 bg-gray-50/50 flex flex-col lg:flex-row gap-2 lg:gap-1 border-b border-gray-200 items-start lg:items-end"
                        id="month_tabs">
                        <div
                            class="flex items-center gap-2 mb-2 lg:mb-[2px] w-full lg:w-auto border-b lg:border-none pb-2 lg:pb-0">
                        ...
                        <div class="flex overflow-x-auto w-full pb-2 lg:pb-0 no-scrollbar gap-1">
                ...
                <!-- List Table -->
                <form name="fquotelist" id="fquotelist" action="./admin_quote.php" onsubmit="return fquotelist_submit(this);"
                    method="post">
                        ...
                        <table class="w-full text-left text-sm whitespace-nowrap">
                            <thead class="bg-gray-50 text-gray-500 font-medium border-b">
                                <tr>
                                    ...
                                    <th class="p-4 text-center">요약</th>
                                    ...
                                    while ($row = sql_fetch_array($result)) {
                                        ...
                                        ?>
                                                <tr class="hover:bg-gray-50 transition cursor-pointer"
                                                    ...
                                                    <td class="p-4 max-w-xs truncate text-gray-600" title="<?php echo $row['qa_subject']; ?>">
    ...
    <?php elseif ($w == 'form'): // -------------------- FORM VIEW -------------------- ?>
            ...
            <div class="step-nav">
                <div class="step-item" onclick="navigateToPage('./admin_quote_step1.php?w=form&qa_id=<?php echo $qa_id; ?>')">
            ...
            <form name="fquote" id="fquote" action="./admin_quote.php" method="post" onsubmit="return fquote_submit(this);"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-10 gap-8 items-start">
                    ...
                    <div class="lg:col-span-7 space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <div
                                class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 pb-4 border-b border-gray-100 gap-4">
                                <div class="flex items-center gap-3">
                                    <button type="button" onclick="navigateToPage('./admin_quote.php')"
                                        class="bg-white border border-gray-300 text-gray-600 hover:bg-gray-50 px-3 py-1.5 rounded-lg text-xs font-bold transition flex items-center gap-1">
                                        <span>◀</span> 목록으로
                                    </button>
                                ...
                                <div class="flex flex-wrap items-center gap-3">
                                    ...
                                    <div
                                        class="flex items-center gap-2 bg-orange-50 px-3 py-1.5 rounded-lg border border-orange-100">
                                        ...
                                        <div class="relative w-32">
                                            <select id="qa_status_select" onchange="handle_status_change(this)"
                                                ...
                                                ?>
                                                <option value="__custom__" <?php echo $is_custom ? 'selected' : ''; ?>>➕ 직접
                                                    입력...</option>
                                            </select>
                            ...
                            <div class="grid grid-cols-12 gap-4">
                                ...
                                <div class="col-span-12 lg:col-span-3">
                                    ...
                                    <input type="email" name="qa_client_email" value="<?php echo $quote['qa_client_email']; ?>"
                                        class="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 text-xs py-2"
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div class="overflow-x-auto -mx-6 px-6">
                                ...
                                <table class="w-full text-left border-collapse min-w-[800px]" id="tbl_items_new">
                                    <thead
                                        class="bg-gray-50 text-gray-500 text-xs uppercase font-bold border-b border-gray-200">
                                        <tr>
                                            <th class="py-3 px-1 md:px-2 w-8"></th>
                                            <th class="py-3 px-1 md:px-2 min-w-[100px]">품목<br class="md:hidden"/>(ITEM)</th>
                                            <!-- FIX: Split spec into W/H -->
                                            <th class="py-3 px-1 md:px-2 w-16 md:w-24 text-center">가로<br class="md:hidden"/>(W)</th>
                                            <th class="py-3 px-1 md:px-2 w-16 md:w-24 text-center">세로<br class="md:hidden"/>(H)</th>
                            ...
                            <div class="mt-4 pt-4 border-t border-dashed flex justify-center relative z-10">
                                <button type="button" id="btn_add_item_row"
                                    class="flex items-center gap-2 px-6 py-3 bg-orange-50 text-orange-700 hover:bg-orange-100 rounded-lg text-sm font-bold transition cursor-pointer shadow-sm hover:shadow">
                            ...
                            <div class="p-5">
                                <div class="space-y-6">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div
                                            class="flex justify-between text-gray-900 text-xl font-extrabold border-t pt-3 items-end">
                                            <span>총 합계</span>
                                            <span class="text-orange-600 font-mono text-2xl"><span
                                                    id="txt_total">0</span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-blue-50/50 rounded-lg p-4 border border-blue-100 space-y-3">
                                        ...
                                        <div
                                            class="flex justify-between items-center text-red-600 font-bold border-t border-dashed border-blue-200 pt-2">
            ...
            function add_item_row(data = null, markDirty = true) {
                ...
                <tr class="main-row group bg-white hover:bg-gray-50 transition border-b border-gray-100 text-sm">
                    ...
                    <td class="py-2 px-1 md:px-2 align-top">
                        <input type="text" name="qi_item[]" value="${item}" class="w-full p-1.5 md:p-2 text-xs md:text-sm border border-gray-300 rounded font-bold text-gray-800 in-item focus:ring-2 focus:ring-orange-500 focus:border-orange-500" placeholder="품목명" onkeydown="check_enter_add(event, this)">
                    </td>
                    <!-- FIX: Split spec into W/H -->
                    <td class="py-2 px-1 md:px-2 align-top">
                    ...
                    <td class="py-2 px-1 md:px-2 align-top">
                        <input type="text" name="qi_note[]" value="${note}" class="w-full p-1.5 md:p-2 text-xs md:text-sm border border-gray-300 rounded text-gray-600 in-note focus:ring-2 focus:ring-orange-500" placeholder="비고" onkeydown="check_enter_add(event, this)">
                    </td>
        ...
        <form action="./admin_quote.php" method="post" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div class="border-b pb-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2"><label class="block text-xs font-bold mb-1 text-gray-600">이메일</label><input
                            type="email" name="biz_email" value="<?php echo $biz_info['biz_email'] ?? ''; ?>"
                            class="w-full border border-gray-300 p-2.5 rounded focus:border-orange-500 focus:ring-1 focus:ring-orange-500">
                    </div>
                </div>
            </div>
...
<div id="save_preview_confirm_modal" class="hidden fixed inset-0 z-[10002]" role="dialog"
    aria-modal="true">
    <!-- Flex Container for Centering (모바일에서도 중앙 정렬) -->
    <div class="fixed inset-0 z-[100000] flex items-center justify-center p-4 text-center" style="pointer-events: none;">
        
        <!-- Overlay -->
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true"
            style="z-index: 99998 !important; pointer-events: auto;" onclick="close_save_preview_confirm()"></div>
...
<div id="preview_modal" class="hidden fixed inset-0 z-[10005]" role="dialog" aria-modal="true">
    <div class="flex items-center justify-center min-h-screen p-2 sm:p-4">
        ...
        <!-- Center Modal -->
        <div
            class="relative z-[10010] inline-block bg-white rounded-lg overflow-hidden shadow-xl transform transition-all w-full max-w-5xl h-[95vh] sm:h-[90vh] flex flex-col pointer-events-auto">
            ...
            <!-- Header -->
            <div class="bg-gray-50 px-3 py-2 sm:px-6 sm:py-4 border-b border-gray-200 flex justify-between items-center">
...
<!-- Custom Confirm Modal (3 Buttons: Save/Don't Save/Cancel) -->
<div id="back_confirm_modal_safe" class="hidden fixed inset-0 z-[99999]" role="dialog"
    aria-modal="true">
...
<div id="summary_modal" class="hidden fixed inset-0 z-[10000] overflow-y-auto" role="dialog" aria-modal="true">
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" onclick="close_summary_modal()"></div>
